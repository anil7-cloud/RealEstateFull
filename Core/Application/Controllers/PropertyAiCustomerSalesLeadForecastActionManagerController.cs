...
public class PropertyAiCustomerSalesLeadForecastActionManagerController : ControllerBase
{
    private readonly IPropertyAiCustomerSalesLeadForecastActionService _actionService;

    public PropertyAiCustomerSalesLeadForecastActionManagerController(
    ...
    [HttpGet("action/history/{userId}")]
    public async Task<IActionResult> GetActionHistory(int userId)
    {
