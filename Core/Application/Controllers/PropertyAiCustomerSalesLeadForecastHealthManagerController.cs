...
public class PropertyAiCustomerSalesLeadForecastHealthManagerController : ControllerBase
{
    private readonly IPropertyAiCustomerSalesLeadForecastCoreService _healthService;

    public PropertyAiCustomerSalesLeadForecastHealthManagerController(
